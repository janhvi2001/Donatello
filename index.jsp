            ...
            <section id="intro" class="s-intro target-section">
                ...
                <div class="row s-intro__content">
                    ...
                    <div class="column lg-12 s-intro__content-inner">
                        <h3 class="s-intro__pretitle">This is Donatello.</h3>
                        <h1 class="s-intro__title">
                        The absolute touch of<br>
                ...
                <div class="row s-about__content" data-animate-block>
                    <div class="column lg-12">
                        ...
                        <p class="s-about__desc" data-animate-el>
                            <span>Donatello</span> is a creative digital agency 
                            composed of creative designers who provide best art wall designs.
                        </p>
                    </div> <!-- end column  -->
            ...
            <section id="services" class="s-services">
                ...
                <div class="row narrow section-header section-header--dark has-bottom-sep">
                    <div class="column lg-12">
                        ...
                        <p class="lead">This brand is mainly focused on providing customers with the best possible art wall solution. We also consider providing the accessories for the same
                    ...
                    <div class="row services-list block-lg-one-half block-tab-whole" data-animate-block>
                        ...
                        <div class="column service-item" data-animate-el>
                            ...
                            <div class="service-content">
                                <h3 class="h4">Wall Art Solutions</h3>

                                <p>
                                We provide customers with magnanimous numbers of wall art ideas and also help them 
                                gain the same by getting it done by our helpers. The designers themselves take initiative 
                                in reshaping and renovating every single wall of every project undertaken.
                                </p>
                            </div>
                        ...
                        <div class="column service-item" data-animate-el>
                            ...
                            <div class="service-content">
                                <h3 class="h4">Authentic Designs</h3>
                        ...
                        <div class="column service-item" data-animate-el>
                            ...
                            <div class="service-content">
                                ...
                                <p>
                                From designing walls to providing supplements for the same, we 
                        ...
                        <div class="folio-list bricks">
                            ...
                            <div class="brick folio-item"   data-animate-el>
                                ...
                                <div class="folio-item__thumb">
                                    <a class="folio-item__thumb-link" href="images/portfolio/gallery/p1.webp" Title="Copper Nights" data-size="1050x700">
                                        <img src="images/portfolio/p1.webp" 
                                             srcset="images/portfolio/p1.webp 1x, images/portfolio/p1.webp 2x" alt="">
                                    </a>
                                </div>
                                <div class="folio-item__info">
                                    <div class="folio-item__cat">Project</div>
                                    <h4 class="folio-item__title">Copper Nights</h4>
                                </div>
                                ...
                                <div class="folio-item__caption">
                                    <p>It consists of a mural kind of artificial abstract art wall with intricate patterns show casing the beauty of the dining hall.</p>
                                </div>
                            ...
                            <div class="brick folio-item" data-animate-el>
                                ...
                                <div class="folio-item__thumb">
                                    <a class="folio-item__thumb-link" href="images/portfolio/gallery/pic4.jpg" Title="Subtle Confession" data-size="1050x700">
                                        <img src="images/portfolio/p2.webp" 
                                             srcset="images/portfolio/p2.webp 1x, images/portfolio/p2.webp 2x" alt="">
                                    </a>
                                </div>
                                <div class="folio-item__info">
                                    <div class="folio-item__cat">Project</div>
                            ...
                            <div class="brick folio-item" data-animate-el>
                                ...
                                <div class="folio-item__thumb">
                                    <a class="folio-item__thumb-link" href="images/portfolio/gallery/g-japandi1.jfif" Title="Japandi Summers" data-size="1050x700">
                                        <img src="images/portfolio/p3.jpg" 
                                             srcset="images/portfolio/p3.jpg 1x, images/portfolio/p3.jpg 2x" alt="">
                                    </a>
                                </div>
                                <div class="folio-item__info">
                                    <div class="folio-item__cat">Project</div>
