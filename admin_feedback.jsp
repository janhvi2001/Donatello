...
<html>
	...
	MongoDatabase database=mongoc.getDatabase("Artwall");
        MongoCollection<Document> c=database.getCollection("feedback");
        ...
        int i=1;
         ...
         out.println("<tr><td>"+i+"</td><td>"+d.getString("name")+"</td><td>"+d.getString("email")+"</td><td>"+d.getString("phone")+"</td><td>"+d.getString("feedback")+"</td></tr>");
         i++;
